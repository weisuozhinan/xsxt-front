      ...
      <div style="display: flex;justify-content: space-between">
        <div>
          <el-input style="width: 300px;margin-right: 10px" prefix-icon="el-icon-search"
                    v-model="teaName" @keydown.enter.native="initTeas" clearable @clear="initTeas"
                    :disabled="showAdvanceSearchVisible"
                    placeholder="请输入教师名称进行搜索..."></el-input>
          <el-button type="primary" icon="el-icon-search" @click="initTeas" :disabled="showAdvanceSearchVisible">搜索
          </el-button>
        ...
        <div>
          <el-button type="primary" icon="el-icon-plus" @click="showAddTeaView">添加教师</el-button>
        </div>
      </div>
    </div>
      ...
      <div v-show="showAdvanceSearchVisible"
        ...
        <el-row>
          ...
          <el-col :span="5" :offset="4">
            ...
            <el-button @click="initTeas('advanced')" icon="el-icon-search" type="primary" size="mini">搜索</el-button>
          </el-col>
        </el-row>
      </div>
    </transition>
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="姓名" prop="name">
                <el-input size="mini" style="width: 150px" v-model="tea.name" placeholder="请输入姓名:"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="性别" prop="gender">
                <el-radio-group v-model="tea.gender" style="margin-top: 12px">
                  <el-radio label="男">男</el-radio>
                  <el-radio label="女">女</el-radio>
                </el-radio-group>
              </el-form-item>
            ...
            <el-col :span="6">
              <el-form-item label="用户名" prop="username">
                <el-input size="mini" style="width: 150px" v-model="tea.username" placeholder="请输入用户名:"></el-input>

              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="密码" prop="password">
                <el-input size="mini" style="width: 150px" v-model="tea.password" placeholder="请输入密码:"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="8">
              <el-form-item label="手机号码" prop="phone">
                <el-input size="mini" style="width: 150px" v-model="tea.phone" placeholder="请输入手机号码:"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="学院" prop="dept">
                <el-input size="mini" style="width: 150px" v-model="tea.dept" placeholder="请输入学院:"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="专业" prop="major">
                <el-input size="mini" style="width: 150px" v-model="tea.major" placeholder="请输入专业:"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
  ...
  methods: {
    deleteMany() {
      this.$confirm('此操作将永久删除 [' + this.multipleSelection.length + ']条数据，是否继续？', '提示', {
        ...
        this.deleteRequest('/teacher/' +ids).then(resp => {
          if (resp) {
            if (this.showAdvanceSearchVisible) {
              this.initTeas('advanced');
            } else {
              this.initTeas();
            }
          }
    ...
    deleteTea(data) {
      this.$confirm('此操作将永久删除 ' + data.name + '，是否继续？', '提示', {
        ...
        this.deleteRequest('/teacher/' + data.id).then(resp => {
          if (resp) {
            if (this.showAdvanceSearchVisible) {
              this.initTeas('advanced');
            } else {
    ...
    doAddTea() {
      ...
      if (this.tea.id) {
        ...
        this.$refs['teaForm'].validate(valid => {
          if (valid) {
            this.putRequest('/teacher/', this.tea).then(resp => {
              if (resp) {
        ...
        this.$refs['teaForm'].validate(valid => {
          if (valid) {
            this.postRequest('/teacher/', this.tea).then(resp => {
              if (resp) {
                this.dialogVisible = false;
                this.initTeas();
              }
    ...
    initTeas(type) {
      this.loading = true;
      let url = '/teacher/?currentPage=' + this.currentPage + '&size=' + this.size;
